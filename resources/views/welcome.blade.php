    ...
    <body class="bg-gray-50">
        ...
        <section class="relative min-h-screen bg-gradient-to-b from-indigo-900 via-purple-900 to-indigo-800 overflow-hidden">
            ...
            <div class="absolute bottom-0 w-full">
                <svg class="w-full h-48" viewBox="0 0 1440 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                        d="M0,150 L60,150 L120,100 L180,150 L240,120 L300,150 L360,100 L420,150 L480,120 L540,150 L600,100 L660,150 L720,120 L780,150 L840,100 L900,150 L960,120 L1020,150 L1080,100 L1140,150 L1200,120 L1260,150 L1320,100 L1380,150 L1440,150 L1440,200 L0,200 Z"
                        fill="#1a365d" />
                </svg>
            </div>
            ...
            <div class="relative container mx-auto px-6 pt-32 pb-48">
                <div class="text-center">
                    ...
                    <button
                        class="bg-yellow-500 hover:bg-yellow-400 text-indigo-900 font-bold py-3 px-8 rounded-full transform transition hover:scale-105">
                        Get Started
                    </button>
                </div>
            </div>
                        ...
                        <div class="bg-white rounded-lg shadow-lg overflow-hidden transform transition hover:scale-105">
                            ...
                            <div class="p-6">
                                ...
                                <a href="/recipes/{{ $recipe->id }}">
                                    <button class="text-yellow-500 hover:text-yellow-600 font-semibold">View Recipe
                                        →</button>
                                </a>
                            </div>
                        </div>
        ...
        <section class="py-20 bg-white">
            <div class="container mx-auto px-6 text-center">
                <h2 class="text-4xl font-bold text-indigo-900 mb-8">Statistiques</h2>
                <p class="text-gray-600 max-w-3xl mx-auto mb-8">
                    nombre total de publications et des recettes les plus populaires.
                </p>
                <div class="flex items-center justify-evenly flex-col md:flex-row gap-8">
                    <!-- Total Publications Card -->
                    <div
                        class="bg-white rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition-all max-w-lg w-full duration-300">
                        <div class="p-8 relative">
                            <div
                                class="absolute top-4 right-4 w-12 h-12 bg-indigo-100 rounded-full flex items-center justify-center">
                                <i class="fas fa-newspaper text-2xl text-indigo-600"></i>
                            </div>
                            <div class="space-y-4">
                                <h3 class="text-xl font-bold text-gray-800">Total des publications</h3>
                                <div class="flex items-baseline space-x-2">
                                    <span class="stat-number text-4xl font-bold text-indigo-600">{{ $postsCount }}</span>
                                ...
                                <p class="text-sm text-gray-500">
                                    ...
                                    <span class="ml-1">12% plus que le mois dernier</span>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Total Recipes Card -->
                    <div
                        class="bg-white rounded-2xl shadow-xl overflow-hidden max-w-lg w-full transform hover:scale-105 transition-all duration-300">
                        <div class="p-8 relative">
                            <div
                                class="absolute top-4 right-4 w-12 h-12 bg-yellow-100 rounded-full flex items-center justify-center">
                                <i class="fas fa-utensils text-2xl text-yellow-600"></i>
                            </div>
                            <div class="space-y-4">
                                <h3 class="text-xl font-bold text-gray-800">Total des recettes</h3>
                                <div class="flex items-baseline space-x-2">
                                    <span class="stat-number text-4xl font-bold text-yellow-600">{{ $recipiesCount }}</span>
                                ...
                                <p class="text-sm text-gray-500">
                                    <i class="fas fa-arrow-up text-green-500"></i>
                                    <span class="ml-1">8% plus que le mois dernier</span>
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <section class="py-20 bg-white">
            <div class="container mx-auto px-6 text-center">
                ...
                <p class="text-gray-600 max-w-3xl mx-auto mb-8">
                    Ramadan'On is a platform to explore traditional recipes, share personal experiences, and connect with
                    the global Ramadan community. Join us in celebrating this blessed month through food, stories, and
